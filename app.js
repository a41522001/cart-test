 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const cp="FirebaseError";class Ht extends Error{constructor(e,n,r){super(n),this.code=e,this.customData=r,this.name=cp,Object.setPrototypeOf(this,Ht.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,lr.prototype.create)}}class lr{constructor(e,n,r){this.service=e,this.serviceName=n,this.errors=r}create(e,...n){const r=n[0]||{},s=`${this.service}/${e}`,i=this.errors[e],o=i?lp(i,r):"Error",a=`${this.serviceName}: ${o} (${s}).`;return new Ht(s,a,r)}}function lp(t,e){return t.replace(up,(n,r)=>{const s=e[r];return s!=null?String(s):`<${r}?>`})}const up=/\{\$([^}]+)}/g;function fp(t){for(const e in t)if(Object.prototype.hasOwnProperty.call(t,e))return!1;return!0}function Wr(t,e){if(t===e)return!0;const n=Object.keys(t),r=Object.keys(e);for(const s of n){if(!r.includes(s))return!1;const i=t[s],o=e[s];if(da(i)&&da(o)){if(!Wr(i,o))return!1}else if(i!==o)return!1}for(const s of r)if(!n.includes(s))return!1;return!0}function da(t){return t!==null&&typeof t=="object"}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class gp{constructor(e,n){this.name=e,this.container=n,this.component=null,this.instances=new Map,this.instancesDeferred=new Map,this.instancesOptions=new Map,this.onInitCallbacks=new Map}get(e){const n=this.normalizeInstanceIdentifier(e);if(!this.instancesDeferred.has(n)){const r=new tp;if(this.instancesDeferred.set(n,r),this.isInitialized(n)||this.shouldAutoInitialize())try{const s=this.getOrInitializeService({instanceIdentifier:n});s&&r.resolve(s)}catch{}}return this.instancesDeferred.get(n).promise}getImmediate(e){var n;const r=this.normalizeInstanceIdentifier(e==null?void 0:e.identifier),s=(n=e==null?void 0:e.optional)!==null&&n!==void 0?n:!1;if(this.isInitialized(r)||this.shouldAutoInitialize())try{return this.getOrInitializeService({instanceIdentifier:r})}catch(i){if(s)return null;throw i}else{if(s)return null;throw Error(`Service ${this.name} is not available`)}}getComponent(){return this.component}setComponent(e){if(e.name!==this.name)throw Error(`Mismatching Component ${e.name} for Provider ${this.name}.`);if(this.component)throw Error(`Component for ${this.name} has already been provided`);if(this.component=e,!!this.shouldAutoInitialize()){if(_p(e))try{this.getOrInitializeService({instanceIdentifier:Jt})}catch{}for(const[n,r]of this.instancesDeferred.entries()){const s=this.normalizeInstanceIdentifier(n);try{const i=this.getOrInitializeService({instanceIdentifier:s});r.resolve(i)}catch{}}}}clearInstance(e=Jt){this.instancesDeferred.delete(e),this.instancesOptions.delete(e),this.instances.delete(e)}async delete(){const e=Array.from(this.instances.values());await Promise.all([...e.filter(n=>"INTERNAL"in n).map(n=>n.INTERNAL.delete()),...e.filter(n=>"_delete"in n).map(n=>n._delete())])}isComponentSet(){return this.component!=null}isInitialized(e=Jt){return this.instances.has(e)}getOptions(e=Jt){return this.instancesOptions.get(e)||{}}initialize(e={}){const{options:n={}}=e,r=this.normalizeInstanceIdentifier(e.instanceIdentifier);if(this.isInitialized(r))throw Error(`${this.name}(${r}) has already been initialized`);if(!this.isComponentSet())throw Error(`Component ${this.name} has not been registered yet`);const s=this.getOrInitializeService({instanceIdentifier:r,options:n});for(const[i,o]of this.instancesDeferred.entries()){const a=this.normalizeInstanceIdentifier(i);r===a&&o.resolve(s)}return s}onInit(e,n){var r;const s=this.normalizeInstanceIdentifier(n),i=(r=this.onInitCallbacks.get(s))!==null&&r!==void 0?r:new Set;i.add(e),this.onInitCallbacks.set(s,i);const o=this.instances.get(s);return o&&e(o,s),()=>{i.delete(e)}}invokeOnInitCallbacks(e,n){const r=this.onInitCallbacks.get(n);if(r)for(const s of r)try{s(e,n)}catch{}}getOrInitializeService({instanceIdentifier:e,options:n={}}){let r=this.instances.get(e);if(!r&&this.component&&(r=this.component.instanceFactory(this.container,{instanceIdentifier:mp(e),options:n}),this.instances.set(e,r),this.instancesOptions.set(e,n),this.invokeOnInitCallbacks(r,e),this.component.onInstanceCreated))try{this.component.onInstanceCreated(this.container,e,r)}catch{}return r||null}normalizeInstanceIdentifier(e=Jt){return this.component?this.component.multipleInstances?e:Jt:e}shouldAutoInitialize(){return!!this.component&&this.component.instantiationMode!=="EXPLICIT"}}function mp(t){return t===Jt?void 0:t}function _p(t){return t.instantiationMode==="EAGER"}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Kr=new Map,cg=new Map,pi=new Map;function _a(t,e){try{t.container.addComponent(e)}catch(n){rn.debug(`Component ${e.name} failed to register with FirebaseApp ${t.name}`,n)}}function nr(t){const e=t.name;if(pi.has(e))return rn.debug(`There were multiple attempts to register component ${e}.`),!1;pi.set(e,t);for(const n of Kr.values())_a(n,t);for(const n of cg.values())_a(n,t);return!0}function gl(t,e){const n=t.container.getProvider("heartbeat").getImmediate({optional:!0});return n&&n.triggerHeartbeat(),t.container.getProvider(e)}function Ze(t){return t.settings!==void 0}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const dg="firebase-heartbeat-database",hg=1,rr="firebase-heartbeat-store";let Hs=null;function _l(){return Hs||(Hs=Op(dg,hg,{upgrade:(t,e)=>{switch(e){case 0:try{t.createObjectStore(rr)}catch(n){console.warn(n)}}}}).catch(t=>{throw xt.create("idb-open",{originalErrorMessage:t.message})})),Hs}async function pg(t){try{const n=(await _l()).transaction(rr),r=await n.objectStore(rr).get(vl(t));return await n.done,r}catch(e){if(e instanceof Ht)rn.warn(e.message);else{const n=xt.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});rn.warn(n.message)}}}async function va(t,e){try{const r=(await _l()).transaction(rr,"readwrite");await r.objectStore(rr).put(e,vl(t)),await r.done}catch(n){if(n instanceof Ht)rn.warn(n.message);else{const r=xt.create("idb-set",{originalErrorMessage:n==null?void 0:n.message});rn.warn(r.message)}}}function vl(t){return`${t.name}!${t.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function gi(){var t;return typeof self<"u"&&((t=self.location)===null||t===void 0?void 0:t.href)||""}function Tg(){return Ea()==="http:"||Ea()==="https:"}function Ea(){var t;return typeof self<"u"&&((t=self.location)===null||t===void 0?void 0:t.protocol)||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Cg(){return typeof navigator<"u"&&navigator&&"onLine"in navigator&&typeof navigator.onLine=="boolean"&&(Tg()||rp()||"connection"in navigator)?navigator.onLine:!0}function Rg(){if(typeof navigator>"u")return null;const t=navigator;return t.languages&&t.languages[0]||t.language||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class dr{constructor(e,n){this.shortDelay=e,this.longDelay=n,ft(n>e,"Short delay should be less than long delay!"),this.isMobile=np()||sp()}get(){return Cg()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Mg(t,e){return ht(t,"POST","/v1/accounts:delete",e)}async function Tl(t,e){return ht(t,"POST","/v1/accounts:lookup",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function On(t,e,n=!1){if(n)return e;try{return await e}catch(r){throw r instanceof Ht&&xg(r)&&t.auth.currentUser===t&&await t.auth.signOut(),r}}function xg({code:t}){return t==="auth/user-disabled"||t==="auth/user-token-expired"}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function qr(t){var e;const n=t.auth,r=await t.getIdToken(),s=await On(t,Tl(n,{idToken:r}));j(s==null?void 0:s.users.length,n,"internal-error");const i=s.users[0];t._notifyReloadListener(i);const o=!((e=i.providerUserInfo)===null||e===void 0)&&e.length?Cl(i.providerUserInfo):[],a=Fg(t.providerData,o),c=t.isAnonymous,l=!(t.email&&i.passwordHash)&&!(a!=null&&a.length),u=c?l:!1,d={uid:i.localId,displayName:i.displayName||null,photoURL:i.photoUrl||null,email:i.email||null,emailVerified:i.emailVerified||!1,phoneNumber:i.phoneNumber||null,tenantId:i.tenantId||null,providerData:a,metadata:new mi(i.createdAt,i.lastLoginAt),isAnonymous:u};Object.assign(t,d)}async function $g(t){const e=rt(t);await qr(e),await e.auth._persistUserIfCurrent(e),e.auth._notifyListenersIfCurrent(e)}function Fg(t,e){return[...t.filter(r=>!e.some(s=>s.providerId===r.providerId)),...e]}function Cl(t){return t.map(e=>{var{providerId:n}=e,r=Ki(e,["providerId"]);return{providerId:n,uid:r.rawId||"",displayName:r.displayName||null,email:r.email||null,phoneNumber:r.phoneNumber||null,photoURL:r.photoUrl||null}})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Rl{constructor(){this.type="NONE",this.storage={}}async _isAvailable(){return!0}async _set(e,n){this.storage[e]=n}async _get(e){const n=this.storage[e];return n===void 0?null:n}async _remove(e){delete this.storage[e]}_addListener(e,n){}_removeListener(e,n){}}Rl.type="NONE";const Ta=Rl;/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Or(t,e,n){return`firebase:${t}:${e}:${n}`}class Tn{constructor(e,n,r){this.persistence=e,this.auth=n,this.userKey=r;const{config:s,name:i}=this.auth;this.fullUserKey=Or(this.userKey,s.apiKey,i),this.fullPersistenceKey=Or("persistence",s.apiKey,i),this.boundEventHandler=n._onStorageEvent.bind(n),this.persistence._addListener(this.fullUserKey,this.boundEventHandler)}setCurrentUser(e){return this.persistence._set(this.fullUserKey,e.toJSON())}async getCurrentUser(){const e=await this.persistence._get(this.fullUserKey);return e?at._fromJSON(this.auth,e):null}removeCurrentUser(){return this.persistence._remove(this.fullUserKey)}savePersistenceForRedirect(){return this.persistence._set(this.fullPersistenceKey,this.persistence.type)}async setPersistence(e){if(this.persistence===e)return;const n=await this.getCurrentUser();if(await this.removeCurrentUser(),this.persistence=e,n)return this.setCurrentUser(n)}delete(){this.persistence._removeListener(this.fullUserKey,this.boundEventHandler)}static async create(e,n,r="authUser"){if(!n.length)return new Tn(ct(Ta),e,r);const s=(await Promise.all(n.map(async l=>{if(await l._isAvailable())return l}))).filter(l=>l);let i=s[0]||ct(Ta);const o=Or(r,e.config.apiKey,e.name);let a=null;for(const l of n)try{const u=await l._get(o);if(u){const d=at._fromJSON(e,u);l!==i&&(a=d),i=l;break}}catch{}const c=s.filter(l=>l._shouldAllowMigration);return!i._shouldAllowMigration||!c.length?new Tn(i,e,r):(i=c[0],a&&await i._set(o,a.toJSON()),await Promise.all(n.map(async l=>{if(l!==i)try{await l._remove(o)}catch{}})),new Tn(i,e,r))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Dl(t,e=[]){let n;switch(t){case"Browser":n=Ca(Pe());break;case"Worker":n=`${Ca(Pe())}-${t}`;break;default:n=t}const r=e.length?e.join(","):"FirebaseCore-web";return`${n}/JsCore/${fr}/${r}`}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function zg(t,e={}){return ht(t,"GET","/v2/passwordPolicy",jt(t,e))}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function lm(t,e){return hr(t,"POST","/v1/accounts:signInWithPassword",jt(t,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function um(t,e){return hr(t,"POST","/v1/accounts:signInWithEmailLink",jt(t,e))}async function fm(t,e){return hr(t,"POST","/v1/accounts:signInWithEmailLink",jt(t,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Cn(t,e){return hr(t,"POST","/v1/accounts:signInWithIdp",jt(t,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const dm="http://localhost";class sn extends Yi{constructor(){super(...arguments),this.pendingToken=null}static _fromParams(e){const n=new sn(e.providerId,e.signInMethod);return e.idToken||e.accessToken?(e.idToken&&(n.idToken=e.idToken),e.accessToken&&(n.accessToken=e.accessToken),e.nonce&&!e.pendingToken&&(n.nonce=e.nonce),e.pendingToken&&(n.pendingToken=e.pendingToken)):e.oauthToken&&e.oauthTokenSecret?(n.accessToken=e.oauthToken,n.secret=e.oauthTokenSecret):qe("argument-error"),n}toJSON(){return{idToken:this.idToken,accessToken:this.accessToken,secret:this.secret,nonce:this.nonce,pendingToken:this.pendingToken,providerId:this.providerId,signInMethod:this.signInMethod}}static fromJSON(e){const n=typeof e=="string"?JSON.parse(e):e,{providerId:r,signInMethod:s}=n,i=Ki(n,["providerId","signInMethod"]);if(!r||!s)return null;const o=new sn(r,s);return o.idToken=i.idToken||void 0,o.accessToken=i.accessToken||void 0,o.secret=i.secret,o.nonce=i.nonce,o.pendingToken=i.pendingToken||null,o}_getIdTokenResponse(e){const n=this.buildRequest();return Cn(e,n)}_linkToIdToken(e,n){const r=this.buildRequest();return r.idToken=n,Cn(e,r)}_getReauthenticationResolver(e){const n=this.buildRequest();return n.autoCreate=!1,Cn(e,n)}buildRequest(){const e={requestUri:dm,returnSecureToken:!0};if(this.pendingToken)e.pendingToken=this.pendingToken;else{const n={};this.idToken&&(n.id_token=this.idToken),this.accessToken&&(n.access_token=this.accessToken),this.secret&&(n.oauth_token_secret=this.secret),n.providerId=this.providerId,this.nonce&&!this.pendingToken&&(n.nonce=this.nonce),e.postBody=ur(n)}return e}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ct extends pr{constructor(){super("facebook.com")}static credential(e){return sn._fromParams({providerId:Ct.PROVIDER_ID,signInMethod:Ct.FACEBOOK_SIGN_IN_METHOD,accessToken:e})}static credentialFromResult(e){return Ct.credentialFromTaggedObject(e)}static credentialFromError(e){return Ct.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e||!("oauthAccessToken"in e)||!e.oauthAccessToken)return null;try{return Ct.credential(e.oauthAccessToken)}catch{return null}}}Ct.FACEBOOK_SIGN_IN_METHOD="facebook.com";Ct.PROVIDER_ID="facebook.com";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class At extends pr{constructor(){super("github.com")}static credential(e){return sn._fromParams({providerId:At.PROVIDER_ID,signInMethod:At.GITHUB_SIGN_IN_METHOD,accessToken:e})}static credentialFromResult(e){return At.credentialFromTaggedObject(e)}static credentialFromError(e){return At.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e||!("oauthAccessToken"in e)||!e.oauthAccessToken)return null;try{return At.credential(e.oauthAccessToken)}catch{return null}}}At.GITHUB_SIGN_IN_METHOD="github.com";At.PROVIDER_ID="github.com";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function gm(t,e){return hr(t,"POST","/v1/accounts:signUp",jt(t,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function _m(t,e,n=!1){const{auth:r}=t;if(Ze(r.app))return Promise.reject(ut(r));const s="reauthenticate";try{const i=await On(t,Fl(r,s,e,t),n);j(i.idToken,r,"internal-error");const o=Gi(i.idToken);j(o,r,"internal-error");const{sub:a}=o;return j(t.uid===a,r,"user-mismatch"),on._forOperation(t,s,i)}catch(i){throw(i==null?void 0:i.code)==="auth/user-not-found"&&qe(r,"user-mismatch"),i}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Bl(t,e,n=!1){if(Ze(t.app))return Promise.reject(ut(t));const r="signIn",s=await Fl(t,r,e),i=await on._fromIdTokenResponse(t,r,s);return n||await t._updateCurrentUser(i.user),i}async function vm(t,e){return Bl(un(t),e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Vl(t){const e=un(t);e._getPasswordPolicyInternal()&&await e._updatePasswordPolicy()}async function ym(t,e,n){if(Ze(t.app))return Promise.reject(ut(t));const r=un(t),o=await _i(r,{returnSecureToken:!0,email:e,password:n,clientType:"CLIENT_TYPE_WEB"},"signUpPassword",gm).catch(c=>{throw c.code==="auth/password-does-not-meet-requirements"&&Vl(t),c}),a=await on._fromIdTokenResponse(r,"signIn",o);return await r._updateCurrentUser(a.user),a}function bm(t,e,n){return Ze(t.app)?Promise.reject(ut(t)):vm(rt(t),Nn.credential(e,n)).catch(async r=>{throw r.code==="auth/password-does-not-meet-requirements"&&Vl(t),r})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const T_="__/auth/handler",C_="emulator/auth/handler",R_=encodeURIComponent("fac");async function Ua(t,e,n,r,s,i){j(t.config.authDomain,t,"auth-domain-config-required"),j(t.config.apiKey,t,"invalid-api-key");const o={apiKey:t.config.apiKey,appName:t.name,authType:n,redirectUrl:r,v:fr,eventId:s};if(e instanceof $l){e.setDefaultLanguage(t.languageCode),o.providerId=e.providerId||"",fp(e.getCustomParameters())||(o.customParameters=JSON.stringify(e.getCustomParameters()));for(const[u,d]of Object.entries(i||{}))o[u]=d}if(e instanceof pr){const u=e.getScopes().filter(d=>d!=="");u.length>0&&(o.scopes=u.join(","))}t.tenantId&&(o.tid=t.tenantId);const a=o;for(const u of Object.keys(a))a[u]===void 0&&delete a[u];const c=await t._getAppCheckToken(),l=c?`#${R_}=${encodeURIComponent(c)}`:"";return`${A_(t)}?${ur(a).slice(1)}${l}`}function A_({config:t}){return t.emulator?qi(t,C_):`https://${t.authDomain}/${T_}`}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const M_=5*60,D_=fl("authIdTokenMaxAge")||M_;let Ba=null;const x_=t=>async e=>{const n=e&&await e.getIdTokenResult(),r=n&&(new Date().getTime()-Date.parse(n.issuedAtTime))/1e3;if(r&&r>D_)return;const s=n==null?void 0:n.token;Ba!==s&&(Ba=s,await fetch(t,{method:s?"POST":"DELETE",headers:s?{Authorization:`Bearer ${s}`}:{}}))};function U_(t=fg()){const e=gl(t,"auth");if(e.isInitialized())return e.getImmediate();const n=rm(t,{popupRedirectResolver:k_,persistence:[Vm,Pm,Kl]}),r=fl("authTokenSyncURL");if(r&&typeof isSecureContext=="boolean"&&isSecureContext){const i=new URL(r,location.origin);if(location.origin===i.origin){const o=x_(i.toString());Sm(n,o,()=>o(n.currentUser)),Im(n,a=>o(a))}}const s=ep("auth");return s&&im(n,`http://${s}`),n}function $_(){var t,e;return(e=(t=document.getElementsByTagName("head"))===null||t===void 0?void 0:t[0])!==null&&e!==void 0?e:document}Yg({loadJS(t){return new Promise((e,n)=>{const r=document.createElement("script");r.setAttribute("src",t),r.onload=e,r.onerror=s=>{const i=et("internal-error");i.customData=s,n(i)},r.type="text/javascript",r.charset="UTF-8",$_().appendChild(r)})},gapiScript:"https://apis.google.com/js/api.js",recaptchaV2Script:"https://www.google.com/recaptcha/api.js",recaptchaEnterpriseScript:"https://www.google.com/recaptcha/enterprise.js?render="});L_("Browser");const F_={apiKey:"AIzaSyBm5CfzbOl8mYldxgN5giPFPImcuSQMEXA",authDomain:"online-shopping-mall-ba092.firebaseapp.com",projectId:"online-shopping-mall-ba092",storageBucket:"online-shopping-mall-ba092.appspot.com",messagingSenderId:"212110660805",appId:"1:212110660805:web:1c726ddeb383f52fcf4cac"},B_=ml(F_),Un=U_(B_),Is=Vd("auth",()=>{const t=ee(""),e=ee(""),n=ve(()=>{if(e.value.includes("email-already"))return"電子郵件已被使用";if(e.value.includes("invalid-email"))return"無效的電子郵件";if(e.value.includes("weak-password"))return"密碼最少需要6個字";if(!e.value)return""}),r=ve(()=>{if(e.value!=="")return"錯誤的帳號或密碼"});Tm(Un,a=>{a?t.value=a.displayName:t.value=""});async function s(a,c,l){try{e.value="";const u=await ym(Un,a,c);console.log(u.user),u.user&&await wm(u.user,{displayName:l}),await Oa(Un)}catch(u){e.value=u.code,console.log("註冊失敗",n.value)}}async function i(a,c){e.value="";try{const l=await bm(Un,a,c);t.value=l.user.displayName,console.log(l.user)}catch(l){e.value=l.code,console.log("登入失敗:",l.message)}}async function o(){try{await Oa(Un),t.value="",console.log("登出成功")}catch(a){console.log("登出失敗:",a.message)}}return{signupErrorMessage:n,loginErrorMessage:r,memberName:t,signup:s,login:i,logout:o}}),Wt=(t,e)=>{const n=t.__vccOpts||t;for(const[r,s]of e)n[r]=s;return n},V_=t=>(Bt("data-v-d7b6204d"),t=t(),Vt(),t),H_={key:0,class:"signup-modal"},j_={class:"modal-content"},W_={class:"signup-form"},K_={for:"signup-name"},z_={for:"signup-email"},q_={for:"signup-password"},G_={class:"success-modal"},J_=V_(()=>_("div",{class:"success-modal-content"},[_("p",null,"成功註冊!!"),_("p",null,"請等待跳轉...")],-1)),Y_=[J_],X_={__name:"Signup",setup(t){const e=Is(),n=ee(!1),r=ee(""),s=ee(""),i=ee(""),o=ee(!1),a=ee(!1),c=ee(!1),l=ve(()=>e.signupErrorMessage),u=ee(!1);function d(){n.value=!0,o.value=!1,a.value=!1,c.value=!1}function p(){n.value=!1,s.value="",i.value="",r.value="",o.value=!1,a.value=!1,c.value=!1}const g=async()=>{if(r.value===""||s.value===""||i.value===""){o.value=!0;return}try{if(await e.signup(s.value,i.value,r.value),l.value.includes("密碼")){a.value=!1,c.value=!0;return}else if(l.value.includes("電子")){c.value=!1,a.value=!0;return}else a.value=!1,c.value=!1;u.value=!0,setTimeout(()=>{u.value=!1,p()},2e3)}catch(E){console.log(E)}};return(E,T)=>(ue(),me(_e,null,[_("p",{onClick:T[0]||(T[0]=N=>d())},"註冊"),n.value?(ue(),me("div",H_,[_("div",j_,[_("span",{onClick:T[1]||(T[1]=N=>p())},"×"),_("form",W_,[_("label",K_,[Me("用戶名 "),ge(_("span",null,"請填寫正確的資訊",512),[[Fe,o.value]])]),ge(_("input",{type:"text",id:"signup-name","onUpdate:modelValue":T[2]||(T[2]=N=>r.value=N)},null,512),[[nn,r.value]]),_("label",z_,[Me("電子郵件 "),ge(_("span",null,$e(l.value),513),[[Fe,a.value]])]),ge(_("input",{type:"text",id:"signup-email","onUpdate:modelValue":T[3]||(T[3]=N=>s.value=N)},null,512),[[nn,s.value]]),_("label",q_,[Me("密碼 "),ge(_("span",null,$e(l.value),513),[[Fe,c.value]])]),ge(_("input",{type:"password",id:"signup-password","onUpdate:modelValue":T[4]||(T[4]=N=>i.value=N)},null,512),[[nn,i.value]]),_("button",{onClick:T[5]||(T[5]=Wc(N=>g(),["prevent"]))},"註冊")]),ge(_("div",G_,Y_,512),[[Fe,u.value]])])])):hs("",!0)],64))}},Q_=Wt(X_,[["__scopeId","data-v-d7b6204d"]]),Z_=t=>(Bt("data-v-edf6177e"),t=t(),Vt(),t),ev={key:0,class:"login-modal"},tv={class:"modal-content"},nv={class:"login-form"},rv={for:"login-email"},sv={for:"login-password"},iv={class:"success-modal"},ov=Z_(()=>_("div",{class:"success-modal-content"},[_("p",null,"成功登入!!"),_("p",null,"請等待跳轉...")],-1)),av=[ov],cv={__name:"Login",setup(t){const e=Is(),n=ee(!1),r=ee(""),s=ee(""),i=ee(!1),o=ee(!1),a=ve(()=>e.loginErrorMessage),c=ee(!1),l=async()=>{if(r.value===""||s.value===""){i.value=!0;return}else i.value=!1;try{if(await e.login(r.value,s.value),console.log(a.value),a.value){o.value=!0;return}else o.value=!1;c.value=!0,setTimeout(()=>{c.value=!1,d()},2e3)}catch(p){console.log(p)}};function u(){n.value=!0,r.value="",s.value="",i.value=!1,o.value=!1}function d(){n.value=!1,r.value="",s.value="",i.value=!1,o.value=!1}return(p,g)=>(ue(),me(_e,null,[_("p",{onClick:g[0]||(g[0]=E=>u())},"登入"),n.value?(ue(),me("div",ev,[_("div",tv,[_("span",{onClick:g[1]||(g[1]=E=>d())},"×"),_("form",nv,[_("label",rv,[Me("電子郵件 "),ge(_("span",null,"請填寫帳號或密碼",512),[[Fe,i.value]])]),ge(_("input",{type:"text",id:"login-email","onUpdate:modelValue":g[2]||(g[2]=E=>r.value=E)},null,512),[[nn,r.value]]),_("label",sv,[Me("密碼 "),ge(_("span",null,$e(a.value),513),[[Fe,o.value]])]),ge(_("input",{type:"password",id:"login-password","onUpdate:modelValue":g[3]||(g[3]=E=>s.value=E)},null,512),[[nn,s.value]]),_("button",{onClick:g[4]||(g[4]=Wc(E=>l(),["prevent"]))},"登入")]),ge(_("div",iv,av,512),[[Fe,c.value]])])])):hs("",!0)],64))}},lv=Wt(cv,[["__scopeId","data-v-edf6177e"]]),uv=t=>(Bt("data-v-3990721b"),t=t(),Vt(),t),fv={key:0,class:"logout-modal"},dv={class:"modal-content"},hv=uv(()=>_("p",null,"確定登出嗎?",-1)),pv={__name:"Logout",setup(t){const e=Is(),n=ee(!1);function r(){n.value=!0}function s(){n.value=!1}const i=async()=>{try{await e.logout(),n.value=!1}catch(o){console.log(o)}};return(o,a)=>(ue(),me(_e,null,[_("p",{onClick:a[0]||(a[0]=c=>r())},"登出"),n.value?(ue(),me("div",fv,[_("div",dv,[_("span",{onClick:a[1]||(a[1]=c=>s())},"×"),hv,_("button",{onClick:a[2]||(a[2]=c=>i())},"確定")])])):hs("",!0)],64))}},gv=Wt(pv,[["__scopeId","data-v-3990721b"]]),Ss=t=>(Bt("data-v-7c9ba16f"),t=t(),Vt(),t),mv=Ss(()=>_("label",{class:"hamburger",for:"toggle"},[_("div",{class:"bar"}),_("div",{class:"bar"}),_("div",{class:"bar"})],-1)),_v=Ss(()=>_("input",{type:"checkbox",id:"toggle"},null,-1)),vv={class:"navbar"},yv={class:"logo"},bv={class:"search"},Ev=Ss(()=>_("img",{src:"https://cdn-icons-png.flaticon.com/512/54/54481.png",alt:""},null,-1)),wv=[Ev],Iv={class:"error-modal"},Sv={class:"content"},Tv=Ss(()=>_("p",null,"未搜索到此商品，請輸入正確的關鍵字",-1)),Cv={__name:"Header",setup(t){const e=Is(),n=il(),r=Ae("products"),s=ve(()=>e.memberName),i=ve(()=>!s.value),o=ve(()=>"你好"+s.value+"!"),a=ee(""),c=ee(!1);function l(){if(a.value==="")return;const u=r.value.filter(d=>d.name.includes(a.value));if(u.length===0){a.value="",c.value=!c.value;return}a.value="",n.push({path:`/product/${u[0].id}`})}return(u,d)=>{const p=cs("router-link");return ue(),me(_e,null,[mv,_("header",null,[_v,_("nav",vv,[_("ul",null,[ge(_("li",null,$e(o.value),513),[[Fe,s.value]]),_("li",null,[fe(p,{to:"/home"},{default:kt(()=>[Me("首頁")]),_:1})]),_("li",null,[fe(p,{to:"/cart"},{default:kt(()=>[Me("購物車")]),_:1})]),_("li",null,[fe(Q_)]),_("li",null,[i.value?(ue(),Br(lv,{key:0})):(ue(),Br(gv,{key:1}))])])]),_("div",yv,[_("h1",null,[fe(p,{to:"/home"},{default:kt(()=>[Me("購物網站")]),_:1})])]),_("div",bv,[ge(_("input",{type:"text","onUpdate:modelValue":d[0]||(d[0]=g=>a.value=g),onKeyup:d[1]||(d[1]=Ad(g=>l(),["enter"]))},null,544),[[nn,a.value]]),_("div",{class:"search-pic",onClick:d[2]||(d[2]=g=>l())},wv)])]),fe(Bi,{name:"error-modal"},{default:kt(()=>[ge(_("div",Iv,[_("div",Sv,[_("span",{onClick:d[3]||(d[3]=g=>c.value=!c.value)},"×"),Tv])],512),[[Fe,c.value]])]),_:1})],64)}}},eo=Wt(Cv,[["__scopeId","data-v-7c9ba16f"]]),Rv=t=>(Bt("data-v-0ce4874c"),t=t(),Vt(),t),Av={class:"banner"},Pv=Rv(()=>_("div",{class:"filter"},null,-1)),kv=["src"],Ov={class:"dot-container"},Nv=["onClick"],Lv={__name:"Banner",setup(t){const e=Ae("products"),n=ee(0);function r(o){n.value>=0&&(n.value+=o,n.value>4?n.value=0:n.value<0&&(n.value=4))}function s(o){n.value=o-1}let i;return i=setInterval(()=>r(1),3e3),Di(()=>{clearInterval(i)}),(o,a)=>(ue(),me("div",Av,[Pv,(ue(!0),me(_e,null,$r(Lt(e),(c,l)=>ge((ue(),me("div",{class:"banner-pic",key:l},[_("img",{src:c.image,alt:""},null,8,kv)])),[[Fe,l===n.value]])),128)),_("a",{class:"prev",onClick:a[0]||(a[0]=c=>r(-1))},"❮"),_("a",{class:"next",onClick:a[1]||(a[1]=c=>r(1))},"❯"),_("div",Ov,[(ue(),me(_e,null,$r(5,c=>_("div",{class:ts(["dot",{activeDot:n.value===c-1}]),onClick:l=>s(c)},null,10,Nv)),64))])]))}},Mv=Wt(Lv,[["__scopeId","data-v-0ce4874c"]]),Dv=t=>(Bt("data-v-942561ce"),t=t(),Vt(),t),xv={class:"product-list"},Uv={class:"pic"},$v=Dv(()=>_("div",{class:"filter"},null,-1)),Fv=["src","alt"],Bv={__name:"ProductList",setup(t){const e=Ae("products");return(n,r)=>{const s=cs("router-link");return ue(),me("div",xv,[_("ul",null,[(ue(!0),me(_e,null,$r(Lt(e),i=>(ue(),me("li",{class:"list",key:i.id},[_("div",Uv,[fe(s,{to:`/product/${i.id}`},{default:kt(()=>[$v,_("img",{src:i.image,alt:i.name},null,8,Fv)]),_:2},1032,["to"])]),_("h1",null,[fe(s,{to:`/product/${i.id}`},{default:kt(()=>[Me($e(i.name),1)]),_:2},1032,["to"])]),_("p",null,"$"+$e(i.price),1)]))),128))])])}}},Vv=Wt(Bv,[["__scopeId","data-v-942561ce"]]),Hv={__name:"Home",setup(t){return(e,n)=>(ue(),me(_e,null,[fe(eo),fe(Mv),fe(Vv)],64))}},to=t=>(Bt("data-v-874ca8b4"),t=t(),Vt(),t),jv={class:"cart"},Wv={key:0},Kv=["onUpdate:modelValue"],zv={class:"pic"},qv=["src"],Gv={class:"txt"},Jv={class:"num"},Yv=["onClick"],Xv=["onUpdate:modelValue"],Qv=["onClick"],Zv=["onClick"],ey={class:"footer"},ty={class:"item"},ny=to(()=>_("label",{for:"all-check"},"全選",-1)),ry={class:"item"},sy={key:1,class:"empty"},iy=to(()=>_("p",null,"目前尚未添加商品",-1)),oy={class:"modal"},ay={class:"content"},cy={class:"btn"},ly={class:"nothing"},uy={class:"content"},fy=to(()=>_("p",null,"請選取商品",-1)),dy={__name:"Cart",setup(t){ee(1);const e=ee([]);ar(()=>{localStorage.getItem("cart")&&(e.value=JSON.parse(localStorage.getItem("cart")))});function n(u){e.value.splice(u,1)}bn(e,()=>{localStorage.setItem("cart",JSON.stringify(e.value))},{deep:!0});function r(u,d){if(e.value[d].count+u>=1)e.value[d].count+=u;else return}const s=ve({get:()=>e.value.length>0&&e.value.every(u=>u.checked),set:u=>{e.value.forEach(d=>d.checked=u)}}),i=ve(()=>e.value.reduce((u,d)=>d.checked?u+d.price*d.count:u+0,0)),o=ee(!1),a=ee(!1);function c(){e.value.length>0&&e.value.some(u=>u.checked)?o.value=!0:a.value=!0}function l(){const u=e.value.filter(d=>!d.checked);e.value=u,o.value=!1}return(u,d)=>{const p=cs("router-link");return ue(),me(_e,null,[fe(eo),_("div",jv,[e.value&&e.value.length>0?(ue(),me("ul",Wv,[(ue(!0),me(_e,null,$r(e.value,(g,E)=>(ue(),me("li",{key:g.id},[ge(_("input",{type:"checkbox","onUpdate:modelValue":T=>g.checked=T},null,8,Kv),[[Ko,g.checked]]),_("div",zv,[_("img",{src:g.image,alt:""},null,8,qv)]),_("div",Gv,[_("h1",null,$e(g.name),1),_("p",null,"$"+$e(g.price),1),_("div",Jv,[_("button",{class:"minus",onClick:T=>r(-1,E)},"－",8,Yv),ge(_("input",{type:"number",placeholder:"數量",min:"0",max:"99","onUpdate:modelValue":T=>g.count=T},null,8,Xv),[[nn,g.count]]),_("button",{class:"plus",onClick:T=>r(1,E)},"＋",8,Qv)]),_("button",{class:"del-btn",onClick:T=>n(E)},"刪除",8,Zv)])]))),128)),_("div",ey,[_("div",ty,[ge(_("input",{type:"checkbox",name:"",id:"all-check","onUpdate:modelValue":d[0]||(d[0]=g=>s.value=g)},null,512),[[Ko,s.value]]),ny]),_("div",ry,[_("p",null,[Me("總金額$ "),_("span",null,$e(i.value),1)]),_("button",{onClick:d[1]||(d[1]=g=>c())},"結帳")])])])):(ue(),me("div",sy,[iy,fe(p,{to:"/home"},{default:kt(()=>[Me("前往")]),_:1})]))]),ge(_("div",oy,[_("div",ay,[_("p",null,[Me("總金額$"),_("span",null,$e(i.value),1),Me("確定要付款嗎?")]),_("div",cy,[_("button",{class:"confrim",onClick:d[2]||(d[2]=g=>l())},"確定"),_("button",{class:"cancel",onClick:d[3]||(d[3]=g=>o.value=!1)},"取消")])])],512),[[Fe,o.value]]),ge(_("div",ly,[_("div",uy,[fy,_("button",{onClick:d[4]||(d[4]=g=>a.value=!1)},"確定")])],512),[[Fe,a.value]])],64)}}},hy=Wt(dy,[["__scopeId","data-v-874ca8b4"]]),Ql=t=>(Bt("data-v-41f5a98c"),t=t(),Vt(),t),py={class:"container"},gy={key:0,class:"product"},my={class:"wrap"},_y={class:"pic"},vy=["src"],yy={class:"detail"},by=Ql(()=>_("h3",null,"商品詳情",-1)),Ey={class:"footer"},wy={class:"modal"},Iy={class:"content"},Sy=Ql(()=>_("p",null,"此商品已在購物車內",-1)),Ty={__name:"ProductDetail",setup(t){const e=Ae("products"),n=zh(),r=il(),s=ee(null),i=ee(!1);ar(()=>{const l=n.params.id,u=e.value.find(d=>d.id==l);s.value=u,localStorage.getItem("cart")&&(o.value=JSON.parse(localStorage.getItem("cart")))}),rf(()=>{const l=n.params.id,u=e.value.find(d=>d.id==l);s.value=u});const o=ee([]);function a(){o.value.find(l=>l.id==s.value.id)?i.value=!i.value:(o.value.push(s.value),localStorage.setItem("cart",JSON.stringify(o.value)))}function c(){r.back()}return(l,u)=>(ue(),me(_e,null,[_("div",py,[fe(eo),s.value?(ue(),me("div",gy,[_("div",my,[_("button",{class:"prev",onClick:u[0]||(u[0]=d=>c())},"上一頁"),_("div",_y,[_("img",{src:s.value.image,alt:""},null,8,vy)]),_("h1",null,$e(s.value.name),1),_("p",null,"$"+$e(s.value.price),1),_("div",yy,[by,_("p",null,$e(s.value.description),1)])])])):hs("",!0),_("div",Ey,[_("button",{onClick:u[1]||(u[1]=d=>a())},"加入購物車")])]),ge(_("div",wy,[_("div",Iy,[Sy,_("button",{onClick:u[2]||(u[2]=d=>i.value=!i.value)},"確定")])],512),[[Fe,i.value]])],64))}},Cy=Wt(Ty,[["__scopeId","data-v-41f5a98c"]]),Ry=[{path:"/",redirect:"home"},{path:"/home",name:"home",component:Hv},{path:"/product/:id",name:"productDetail",component:Cy},{path:"/cart",name:"cart",component:hy}],Ay=Wh({history:yh(),routes:Ry}),Py={__name:"App",setup(t){const e=ee([]);return jn("products",e),ar(async()=>{try{const n=await fetch("https://raw.githubusercontent.com/a41522001/product/main/product.json");e.value=await n.json()}catch(n){console.log(n),alert("網址連線錯誤請稍後再試")}}),(n,r)=>{const s=cs("router-view");return ue(),Br(s)}}},no=Od(Py);no.use(Ay);no.use(Dd());no.mount("#app");
